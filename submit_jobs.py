...
DEFAULTINPUT = "/store/mc/Run3Winter20DRPremixMiniAOD/HTo2LongLivedTo4b_MH-125_MFF-12_CTau-900mm_TuneCP5_14TeV_pythia8/GEN-SIM-RAW/110X_mcRun3_2021_realistic_v6-v2/10000/181F649B-EDBE-2046-8CC5-AA23D78CE377.root"
...
def generate_ntuple_config(configtype, newtag, caloparams):
    ...
    # cmd += '--customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleAODEMU_MC '
    # use correct CaloStage2Params; should only change if Layer2 calibration changes
    if caloparams:
        cmd += (
            "--customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_"
            + CALOSTAGE2PARAMS
            + " "
        )
...
for jobtype in COND_LIST:
    ...
    crab_submit_script.write("RUN = " + "testLLP-125" + "\n")
    if jobtype == "def":
    ...
    filename = "submit_run_" + "testLLP-125" + "_" + jobtype + ".py"
